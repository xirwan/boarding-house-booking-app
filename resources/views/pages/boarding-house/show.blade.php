            ...
            <div id="TabsContent" class="px-5">
                <div id="Bonus-Tab" class="tab-content flex flex-col gap-5">
                    <div class="flex flex-col gap-4">
                        @foreach($boardingHouse->bonuses as $boardingHouseBonus)
                            <div
                                ...
                                <div class="flex w-[120px] h-[90px] shrink-0 rounded-[18px] bg-[#D9D9D9] overflow-hidden">
                                    <img src="{{ asset('storage/' . $boardingHouseBonus->image)}}" class="w-full h-full object-cover"
                                        alt="thumbnails">
                                </div>
                                <div>
                                    <p class="font-semibold">{{ $boardingHouseBonus->name }}</p>
                                    <p class="text-sm text-ngekos-grey">{{ $boardingHouseBonus->description }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
