        ...
        <div class="flex flex-col w-full rounded-[30px] border border-[#F1F2F6] p-4 gap-4 bg-white">
            ...
            <div class="flex gap-4">
                ...
                <div class="flex flex-col gap-3 w-full">
                    ...
                    <hr class="border-[#F1F2F6]">
                    <p class="font-semibold text-lg text-ngekos-orange">Rp {{ number_format($room->price_per_month, '2', ',', '.') }}<span
        ...
        <div id="PaymentOptions" class="flex flex-col rounded-[30px] border border-[#F1F2F6] p-5 gap-4 mx-5">
            ...
            <div id="TabContent-Container">
                <div id="DownPayment-Tab" class="tab-content flex flex-col gap-4">
                    <p class="text-sm text-ngekos-grey">You need to pay in cash after conducting the boarding house survey</p>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <p class="font-semibold">Rp {{ number_format($room->price_per_month * $transaction['duration'] * (11/100), '2', ',', '.')}}</p>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                        ...
                        <p class="font-semibold">Rp {{ number_format($room->price_per_month * $transaction['duration'] * (1/100), '2', ',', '.')}}</p>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                        ...
                        <p id="downPaymentPrice" class="font-semibold">Rp {{ number_format(($room->price_per_month * $transaction['duration'] * 30/100) + ($room->price_per_month * $transaction['duration'] * (11/100)) + ($room->price_per_month * $transaction['duration'] * (1/100)), '2', ',', '.')}}</p>
                    </div>
                </div>
                <div id="FullPayment-Tab" class="tab-content flex flex-col gap-4 hidden">
                    <p class="text-sm text-ngekos-grey">You don't need to pay any additional fees when surveying boarding house</p>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <img src="{{ asset('assets/images/icons/card-tick.svg') }}" class="w-6 h-6 flex shrink-0" alt="icon">
                            <p class="text-ngekos-grey">Payment</p>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <p class="font-semibold">Rp {{ number_format($room->price_per_month * $transaction['duration'], '2', ',', '.')}}</p>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <img src="{{ asset('assets/images/icons/receipt-disscount.svg') }}" class="w-6 h-6 flex shrink-0"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <img src="{{ asset('assets/images/icons/receipt-text.svg') }}" class="w-6 h-6 flex shrink-0"
                                alt="icon">
                            <p class="text-ngekos-grey" style="size: ">Grand total</p>
                        </div>
                        <p id="fullPaymentPrice" class="font-semibold">Rp {{ number_format(($room->price_per_month * $transaction['duration']) + ($room->price_per_month * $transaction['duration'] * (11/100)) + ($room->price_per_month * $transaction['duration'] * (1/100)), '2', ',', '.')}}</p>
                    </div>
                </div>
            </div>
        </div>
